...
import { DemandeVisiteDetailsDto } from "@/core/application/demandes-visites/demande-visite-details.dto";

export class ProgrammerDemandeVisiteCommandResponse extends OmitType(
...
export class WrapperResponseProgrammerDemandeVisiteCommandResponseDtoMapper
  implements
    IMapper<
      ProgrammerDemandeVisiteCommandResponse,
      WrapperResponseProgrammerDemandeVisiteCommandResponseDto
    >
{
  mapFrom(
    param: ProgrammerDemandeVisiteCommandResponse,
  ): WrapperResponseProgrammerDemandeVisiteCommandResponseDto {
    return new WrapperResponseProgrammerDemandeVisiteCommandResponseDto(param);
  }

  mapTo(
    param: WrapperResponseProgrammerDemandeVisiteCommandResponseDto,
  ): ProgrammerDemandeVisiteCommandResponse {
    return param.data;
  }
}
