...
export class InterceptPaymentWebhookCommandResponse {
  ...
  export class WrapperResponseInterceptPaymentWebhookCommandResponseDtoMapper implements IMapper<InterceptPaymentWebhookCommandResponse, WrapperResponseInterceptPaymentWebhookCommandResponseDto> {
      mapFrom(param: InterceptPaymentWebhookCommandResponse): WrapperResponseInterceptPaymentWebhookCommandResponseDto {
         return new WrapperResponseInterceptPaymentWebhookCommandResponseDto(param);
      }

      mapTo(param: WrapperResponseInterceptPaymentWebhookCommandResponseDto): InterceptPaymentWebhookCommandResponse {
         return param.data;
      }
  }
