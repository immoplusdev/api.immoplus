...
export class UpdateUserAdditionalDataCommandHandler
  implements ICommandHandler<UpdateUserAdditionalDataCommand>
{
  constructor(
  ...
  async execute(
    command: UpdateUserAdditionalDataCommand,
  ): Promise<UpdateUserAdditionalDataCommandResponse> {
    ...
    const additionalData =
      await this.usersDataRepository.findOne(additionalDataId);

    await this.usersDataRepository.updateOne(additionalDataId, {
