export function dateOperation(params: {
  date: Date;
  amount: number;
  ...
  switch (params.operation) {
    case DateOperationEnum.DAYS_MINUS:
      return new Date(
        params.date.setDate(params.date.getDate() - params.amount),
      );
    ...
    case DateOperationEnum.MONTH_MINUS:
      return new Date(
        params.date.setMonth(params.date.getMonth() - params.amount),
      );
    ...
    case DateOperationEnum.YEAR_MINUS:
      return new Date(
        params.date.setFullYear(params.date.getFullYear() - params.amount),
      );
